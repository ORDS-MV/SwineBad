...
# Download data fromhttps://hub.arcgis.com/datasets/ae25571c60d94ce5b7fcbf74e27c00e0/about
...
ggplot() +
  ...
  labs(title = 'Jahr: {closest_state}') ->p

pp <- animate(p, renderer = gifski_renderer(file="swinemunde.gif"))
